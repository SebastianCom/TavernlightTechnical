...
SpellInfo = {
  ['Default'] = {
    ...
    ['Eternal Winter'] =           {id = 118, words = 'exevo gran mas frigo',  exhaustion = 40000, premium = false,  type = 'Instant', icon = 'eternalwinter',          mana = 1050,   level = 60, soul = 0, group = {[1] = 4000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}},
